...
var _genthaler$elm_maze_war$Example$tests = A2(
...
var _genthaler$elm_maze_war$TestRunner$tests = _genthaler$elm_maze_war$Example$tests;
var _genthaler$elm_maze_war$TestRunner$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_genthaler$elm_maze_war$TestRunner$tests)
};
